  ...
  return (
    <section id="about" className="section-padding bg-background">
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-start mb-20">
          <div className="lg:col-span-3 animate-fade-in" style={{ animationDelay: "0.2s" }}>
            ...
            <div className="space-y-4 text-muted-foreground text-base md:text-lg">
              <p>
                I'm an AI & Machine Learning Engineer and Data Pipeline Architect specialized in 
                <span className="highlight"> AWS machine learning services</span>, 
                <span className="highlight"> predictive analytics</span>, 
                <span className="highlight"> data architecture</span>, and systems integration. 
                Currently advancing my expertise as a Data Engineering & AI Student at Turku University of Applied Sciences.
              </p>
              <p>
                My work focuses on building AI systems that transform raw data into actionable business intelligence, 
                including developing enterprise-grade NLP and prediction systems. I'm the creator of <span className="text-foreground font-medium">NaviCast</span>, 
                a maritime intelligence platform processing millions of vessel data points.
              </p>
              <p>
                With professional fluency in <span className="text-foreground font-medium">English, French,</span> and <span className="text-foreground font-medium">Arabic</span>, plus basic Finnish skills, 
          ...
          <div className="lg:col-span-2 lg:sticky lg:top-24 animate-fade-in" style={{ animationDelay: "0.3s" }}>
            <div className="gradient-border">
              <div className="gradient-border-content relative brutalist-padding">
                <Quote className="absolute top-4 left-4 text-accent opacity-10 w-16 h-16" strokeWidth={1.5} />
        ...
        <div className="mb-16">
          <h3 className="text-2xl md:text-3xl font-bold text-foreground mb-8 text-center">Technical Expertise</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {[ { title: "AI & Predictive Analytics", skills: aiSkills, delay: "0.1s" },
              ...
              >
                <h4 className="font-semibold text-foreground mb-4 text-lg">{category.title}</h4>
