...
export const sampleProjects: ProjectData[] = [
  {
    ...
    description:
      "AI-powered platform processing millions of vessel data points for predictive analytics and anomaly detection in maritime routes.",
    technologies: [
      "Python",
      "AWS SageMaker",
      "TensorFlow",
  ...
  },
  {
    ...
    description:
      "Developed a content recommendation system using collaborative filtering and NLP techniques to personalize user experience.",
  ...
  },
  {
    ...
    description:
      "Architected and implemented a scalable, real-time data processing pipeline using AWS Lambda, Kinesis, and DynamoDB.",
    technologies: [
      "AWS Lambda",
      "Kinesis",
      "DynamoDB",
  ...
  },
  {
    ...
    description:
      "This very website! Built with React, TypeScript, Tailwind CSS, featuring a sleek dark mode and minimalist design.",
...
export const samplePosts: PostData[] = [
  {
    ...
    excerpt:
      "A deep dive into the architecture and capabilities of modern LLMs, exploring transformers, attention mechanisms, and their impact.",
    category: "AI",
    date: "2024-03-10",
    readTime: "8 min read",
    url: "#",
  ...
  },
  {
    ...
    excerpt:
      "A practical guide to designing and implementing scalable, real-time data pipelines using Kinesis, Lambda, and other AWS services.",
    category: "Cloud",
    date: "2024-02-25",
  ...
  },
  {
    ...
    excerpt:
      "Exploring advanced techniques for predicting vessel paths using historical AIS data and sequence models.",
