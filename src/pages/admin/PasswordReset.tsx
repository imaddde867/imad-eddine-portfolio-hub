                ...
                {tempPassword ? (
                  <div className="space-y-4">
                    <Alert className="bg-green-900/30 border-green-800/50 text-green-200">
                      ...
                      <AlertDescription>Your temporary password has been generated</AlertDescription>
                    </Alert>
                    
                    <div className="p-3 bg-slate-800/70 border border-slate-700 rounded-md">
                      <p className="text-xs text-slate-400 mb-1">Your temporary password:</p>
                      <p className="text-md font-mono text-white bg-slate-700/50 p-2 rounded border border-slate-600 text-center">{tempPassword}</p>
                      <p className="text-xs text-slate-400 mt-2">Please use this to log in and then change your password.</p>
                    </div>
