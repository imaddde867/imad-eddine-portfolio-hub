      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="bg-gradient-to-br from-indigo-600/20 to-indigo-900/20 border-indigo-700/30 text-white">
          <CardContent className="p-6">
            <div className="flex justify-between items-start">
              <div>
                <p className="text-indigo-400 text-sm font-medium">Blog Posts</p>
        ...
        <Card className="bg-gradient-to-br from-violet-600/20 to-violet-900/20 border-violet-700/30 text-white">
          <CardContent className="p-6">
            <div className="flex justify-between items-start">
              <div>
                <p className="text-violet-400 text-sm font-medium">Total Views</p>
                  ...
                  {recentProjects.map((project) => (
                    <li key={project.slug} className="flex gap-3 group">
                      ...
                      <div className="flex flex-col justify-between items-end text-right">
                        <p className="text-xs text-slate-500">{project.date ? format(new Date(project.date), 'MMM d, yyyy') : ''}</p>
                      </div>
                  ...
                  {recentPosts.map((post) => (
                    <li key={post.slug} className="flex gap-3 group">
                      ...
                      <div className="flex-1 min-w-0 border-b border-slate-800/50 pb-3">
                        <h3 className="font-medium text-sm group-hover:text-indigo-400 transition-colors">{post.title}</h3>
                        <p className="text-sm text-slate-400 truncate mt-1">{post.excerpt}</p>
